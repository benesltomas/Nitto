...
typedef struct MC_HW_INFO_COMPONENT_REF
{
	plcstring ModelNumber[20];
	plcstring SerialNumber[20];
	plcstring Revision[4];
} MC_HW_INFO_COMPONENT_REF;

typedef struct MC_HARDWARE_INFO_REF
{
	struct MC_HW_INFO_COMPONENT_REF Drive;
	struct MC_HW_INFO_COMPONENT_REF Card[4];
	struct MC_HW_INFO_COMPONENT_REF Motor[2];
